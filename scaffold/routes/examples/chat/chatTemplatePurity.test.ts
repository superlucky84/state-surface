...
const TEMPLATE_FILES = [
  ...
  'scaffold/routes/examples/chat/templates/chatMessages.tsx',
  'scaffold/routes/examples/chat/templates/chatCurrent.tsx',
  'scaffold/routes/examples/chat/templates/chatTyping.tsx',
];
